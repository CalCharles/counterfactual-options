...
python test_option.py --dataset-dir data/interaction_pbIv/ --graph-dir data/ball_vel_graphs --object Ball --buffer-len 500000 --gamma .99 --record-rollouts data/paddle_test --test-trials 20 --num-iters 10 --terminal-type comb --reward-type tcomb --interaction-lambda 100 --parameterized-lambda 100 --true-reward-lambda 0 --epsilon-close 1 --time-cutoff 150 --set-time-cutoff --relative-state --relative-action 4 --gpu 1 --reward-constant 0 --max-steps 100 --print-test --interaction-probability 1 --force-mask 0 0 1 1 0 --use-interact --param-interaction > logs/param_tests/test_ball_velocity.txt


# train SAC-HER forward model
