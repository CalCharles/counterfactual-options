...
if __name__ == "__main__":
    ...
    pushing = RoboPushingEnvironment(joint_mode=sys.argv[3].find("joint") != -1, 
        hard_obstacles=sys.argv[3].find("hard") != -1, 
        planar_mode=sys.argv[3].find("planar") != -1, num_obstacles=0 if sys.argv[3].find("noobs") != -1 else 10)
