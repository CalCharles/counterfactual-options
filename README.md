...
python train_option.py --dataset-dir data/robopushing/interaction_agv/ --object Gripper --env RoboPushing --option-type model --buffer-len 500000 --num-steps 90 --gamma .99 --batch-size 16 --num-iters 10000 --terminal-type comb --reward-type comb --parameterized-lambda 1 --epsilon-close .05 --time-cutoff 30 --set-time-cutoff  --hidden-sizes 256 256 256 --learning-type hersac --grad-epoch 75 --pretrain-iters 1000 --lr 1e-4 --epsilon .1 --epsilon-schedule 200 --select-positive .5 --gpu 1 --resample-timer 20 --tau .005 --log-interval 25 --reward-constant -1 --max-steps 30 --param-recycle .1 --sample-continuous 2 --print-test --pretest-trials 2 --relative-param --sac-alpha -1 --no-input
