...
def test_dataset_terminate_reward():
    ...
    for i in range(len(trainbuffer)):
        print(i, trainbuffer[i].inter, trainbuffer[i].rew, trainbuffer[i].terminate, trainbuffer[i].obs, trainbuffer[i].obs_next)
    replay_buffer = option.policy.her.replay_buffer
    for i in range(len(replay_buffer)):
        print(i, replay_buffer[i].inter, replay_buffer[i].rew, replay_buffer[i].terminate, replay_buffer[i].obs, replay_buffer[i].obs_next)
